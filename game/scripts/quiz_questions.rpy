...
init 101 python:
    ...
    easter_egg_quiz_questions = [
        ...
        QuizQuestion(
        question="freeCodeCamp's is a 501(c)(3) public charity (nonprofit) with a mission to:",
        ...
        false=["A form of communication America used during World War II created by the Navajo people", "A radio station for old acoustic modems", "A way to talk with aliens from other solar systems"],
        ...
        explanation="freeCodeCamp teaches many different programming languages and frameworks, and could be written in any of these. This said, in 2014 when Quincy Larson sat down to start building the first version of version of freeCodeCamp, he chose JavaScript and Node.js. He did this because it had a huge package ecosystem and was relatively easy to program in. Node.js is also very fast, and works well at scale, being a primary language used with Netflix, LinkedIn, and other large websites.",
        ...
        explanation="All of these projects have been a source of inspiration, but Wikipedia is closest analog to what the freeCodeCamp community would ultimately like to become: hundreds of languages represented, with thousands of contributors from a wide variety of backgrounds and interests.",
