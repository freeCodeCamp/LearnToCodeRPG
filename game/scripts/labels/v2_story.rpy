...
label v2_message:
    ...
    player "Not entirely, but this is something that Akira and I ran into yesterday!"
    ...
    menu:
        "Shoot him a quick message":
            ...
            "By the time you return, Akira is waiting at your desk."
            "... he doesn't look happy."
            player "Hi Akira!"
            player "..."
            player "What's wrong?"
            akira "Did you know that I was in a meeting when you messaged?"
            ...
            akira "..."
            akira "I wasn't just in the middle of a meeting."
            akira "I was presenting my screen."
            player "Oh! "
            player "So you mean... everyone saw my message?"
            akira "Not only did they all see your message, but I was presenting to our board members."
        ...
        "Wait until the meeting is finished":
            ...
            "After sending out a message, you and Darius head to the break room for some snacks."
            "By the time you return, Akira is at his desk, typing away."
            ...
            "Once you and Darius prepare to leave, Akira stops you."
            akira "Hey! Talk to me for a second."
            akira "Darius told me that you two thought about contacting me. "
            akira "I'm really, really glad you didn't."
            player "No problem! Was your presentation important?"
            akira "I wasn't just in the middle of a meeting."
            akira "I was presenting my screen."
            player "Oh! "
            player "So you mean... everyone would have seen my message?"
            akira "Not only would they all have seen your message, but I was presenting to our board members."
            player "Board members?"
            akira "The people that fund our company. Basically, the people on top."
            player "Woah! That would have been... INCREDIBLY embarrassing."
            akira "Tell me about it! For you and me both!"
            akira "Always remember When you see that someone is in a meeting, you shouldn't send a message."
            akira "Do exactly as you did earlier and just wait until after things are over."
            akira "You'll never know what you're interrupting until it's too late."
...
label v2_email:
    ...
    player "Wow! That'd really stink if someone got ahold of my password! What should I do?"
    ...
    menu mysterious_email_choices:    
        "Re-create my password":
            ...
            player "“Good evening,"
            player "You have failed a routine CompanyName phishing test. Please email your supervisor no later than 11AM tomorrow to schedule a mandatory security training.”"
            ...
            player "I guess I've got to face the music tomorrow. Lauri is not going to be happy about this..."
        ...
        "Check the sender's email":
            ...
            player "..."
            player "(Gasp!) ryanwebster@ajflke.net... Weird - This isn't a CompanyName Consulting company email! Ryan Webster does work for the Payroll department, but the end of his email should be @goodvibes.com."
        ...
        "Check the domain name":
            ...
            player "..."
            player "Weird! Our company URL is companyname.com, so our reset link should be something like companyname.com/password-reset. This link leads me to company.name.co/pssword-reset."
        ...
        "Something's not right here..." if found_problem:
            ...
            player "“Congratulations! You've passed a routine CompanyName phishing test. Your vigilance is appreciated and helps keep our company safe from cyber attacks and security vulnerabilities.”"
            ...
            player "Oh! So CompanyName must performs these to make sure that we're staying on our toes about our company's private information! I'm glad I listened to my gut!"
...
label v2_venting:
    ...
    mint "Meow?"
    player "A client complained to Lauri today that I didn't complete a task the way that they asked. "
    ...
    menu:
        ...
        "Vent to Annika":
            ...
            player "The thought of Lauri finding out I complained about a customer sounds scary..."
    ...
    menu:
        "Run to the bus stop. You can probably make it!":
            if renpy.random.random() < 0.3:
                ...
                "You listen for a moment, sighing with relief when you hear Lauri's voice as well."
                ...
                "By the time you arrive at work, it is 12:00PM. Lauri does not seem pleased."
                lauri "Nice to see you actually show up."
                player "*Pant*... *Pant...*"
                ...
                lauri "And yet... you're still late."
                player "I'm sorry..."
                lauri "You should have messaged me or someone on the team. Can you tell me why that wasn't the first thing that you did?"
                ...
                lauri "So you think that wasting half of the day trying to GET to the office was a good use of your time?"
                lauri "Did you have your work laptop with you?"
                player "Yes..."
                lauri "(Sigh) Then you also could have just worked from home."
                player "I could have WHAT?"
                lauri "I usually recommend juniors come into the office as much as possible. It's good to be around your team quite a bit in the beginning."
                lauri "I feel that juniors learn more this way."
                lauri "But from time to time, when conditions call for it, I'm more than okay with you working from home."
                player "S-so... I didn't have to panic for almost 2 hours?"
                lauri "Exactly."
                lauri "Get to your desk, please. You've got quite a bit of work to catch up on."
        ...
        "Message someone in your TeamChat and tell the team you're running late.":
            ...
            player "..."
            player "Okay. I guess I'll just message Akira over TeamChat and let him know I'll be running a bit late."
            player "..."
            player "..."
...
label v2_crypto:
    ...
    player "Plus, I can tell Akira all about them, and maybe we can start using them!"
    player "On the other hand, I heard Akira talking about how on our next project, we're going to be using something called Material UI."
    ...
    menu:
        "Learn about Blockchain technology and Fresssh.":
            ...
            akira "That's really cool that you're doing research during your free time."
            akira "It's definitely something that good developers do."
            akira "Unfortunately... I don't think that these technologies will be really useful to us."
            player "Aw man, really? Why?"
            akira "For one, Fresssh, even though it seems pretty cool, is super new. "
            akira "Like, it's fully-released version came out about 6 months ago."
            player "Six MONTHS ago?"
            akira "Yes. Which means that there's barely any documentation on it."
            ...
            akira "What happens if you need to debug something? What if there are some bugs that even the developers of the framework haven't figured out or noticed yet?"
            akira "There doesn't seem to be any communities surrounding this online yet either."
            akira "Companies tend to pick frameworks that have been around for at least a little while for these reasons."
            player "I see..."
            akira "Similarly, Blockchain hasn't been adopted by many major companies either."
            akira "We could certainly use it, but there are far, far less Blockchain developers than, say, Ruby on Rails developers."
            akira "If the client ever needs help in the future to fix a bug in the system we built, and we're not the ones to do it, how will they find people that can do it?"
            akira "Does that make sense?"
            player "It does. I'm sorry!"
            akira "No need. This is a learning experience. "
            akira "Just understand that in the future, as you develop your skills as a junior, that you stick with popular technologies."
            akira "Once you've gained your footing in this field, you should feel free to venture off the beaten path. The sky will be your limit!"
            akira "But for now, we need you down on the earth with us, okay?"
        ...
        "Learn a little bit about Material UI.":
            ...
            akira "Really?"
            akira "That's great! That's the kind of enthusiasm we like to see."
            akira "No one on the team has ever used it yet. I'd love it if you could give a minor presentation on what you've learned!"
            player "I'd be glad to!"
            akira "Great. Keep this up, and you'll always be an asset to the team."
...
label v2_old_friend:
    ...
    player "I am! I actually just landed my first software development job! I'm a junior developer at CompanyName."
    greg "CompanyName? Man, I love that place! I've heard awesome things about their company culture."
    ...
    Layla "Isn't CompanyName hiring? You may want to think about referring him!"
    ...
    menu:
        "Would you like me to refer you to a position at my company?":
            ...
            $ calendar.next()
            lauri "So. Would you mind explaining yourself?"
            player "(It's so early... is Lauri already mad at me?)"
            player "Hi Lauri; What am I explaining?"
            lauri "We had an interview scheduled for your friend... Greg, was it?"
            player "Oh right, Greg! How did it go?"
            lauri "Great. If you think showing up 15 minutes late to your first interview with a very loose tie and mis-matched socks is good, then great. Really great!"
            player "Oh jeez... did he at least interview well?"
            lauri "I've never been called “dude” so many times in my life by one person."
            lauri "When we asked him about noteworthy skills, he explained, in GREAT detail, how he ate 30 pieces of pizza on a dare once in college. "
            lauri "He also likes drinking Ranch with his pizza."
            player "I see."
            player "Wait."
            player "You mean... PUTTING ranch ON his pizza, right?"
            lauri "I know what I said."
            player "..."
            lauri "The next time that you think about referring someone to the company... do spend a bit more time vetting them before sending in their resume, please."
