...
label v2_css:
    ...
    player "I'm a bit worried, because one of the classes that are being used is used in a handful of other places."
...
label v2_thick:
    ...
    player "We all agreed during backlog grooming that fixing this bug would all take about four days to complete."
...
label v2_success:
    ...
    menu:
        ...
        "Should we tell someone about this?":
            ...
            player "But that's the good thing of telling someone on your own terms, right?"
...
label v2_competent:
    ...
    menu v2_competent_choices:
        ...
        "Use Universal Search to find other places that the function is used":
            ...
            player "Using this, I can search every single document in our repo. Which also let's me see all of the places that background_jobs() is being ran."
            ...
            player "That way, I can get an idea of what situations it's meant to be used in. This will give me a clue on hwo the function is supposed to be used."
        ...
        "Look at tests for the function":
            ...
            player "The texts can give me a hint on what the function is meant to do."
    ...
    player "Time to get started on chasing this bug!"
...
label v2_automate:
    ...
    player "But... WHY? There is a LOT of minutes here - it feels like it's going to take forever."
    ...
    player "I remember scrolling through Youtube and seeing a video from FreeCodeCamp about automating Excel sprpeadsheets using Python."
    ...
    menu:
        ...
        "Spend some time automating the minutes process.":
            player "Hm... I really can't help but shake the idea that this process can be automated."
...
label v2_where_to_start:
    ...
    teen "I've started to teach myself to code a few months ago; I'm really close to graduating high school, and I like it a lot!"
    ...
    teen "I've been reading a lot of articles online to learn what I need to do to start preparing to look for a real job in the field, since I graduate in about six months."
    ...
    menu:
        ...
        "...have a few cool features, and use at least one API":
            ...
            player "and I wanted a million features, and to use a million different technologies, and spend hours making the app look just right..."
        ...
        "...have as many features and technologies as possible":
            ...
            annika "Once you know one programming language, you can kind of pick up on any of them."
