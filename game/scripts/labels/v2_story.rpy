...
label v2_family_business:
    ...
    player @ laugh "I'm so proud of you. (Smile)"
    josephine blush "Thanks. It's not THAT big of a deal... (BLUSH)"
    ...
    josephine "..."
    josephine blush "Momma and Vati want me to be happy. (BLUSH)"
