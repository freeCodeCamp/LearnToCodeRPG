label v2_working_late:
    ...
    menu:
        "I'm pretty sure this will take more than two days.":
            player "I'm not so sure that's possible Oliver. We have other projects that we have to make sure that we complete on time."
                ...
                "(I'm still not sure about this. We should talk to the client a bit more.)":
                    ...
                    menu:
                        "I think we need to consult with Goro about this first.":
                            ...
                            "Goro offers to hop on a call along with Oliver to give a technical perspective on the project, and work out a timeline and some technical solutions that are more realistic with the timeline that the client has asked for."
                            ...
                            goro "You should always come to a senior developer just like you did to get a second decision when you're unsure of a commitment you're being asked to make."
                        ...
                        "Maybe I could stay a little late. Okay.":
                            ...
                            oliver "Just let me know if you have any questions. I'll shoot you the information on the project when "
                            ...
                            player "Hi Goro. I can't - I promised that I'd work to get the Stacy & Lucy's account's website finished in time."
                            ...
                            goro "I'll talk to Oliver. What will probably happen is that I'll hop on a call with him and the client and help him explain that what they're asking for won't be able to get done in the period of time that they're asking for."
                            ...
                            goro "Other clients that have been waiting longer than S & L might get their projects completed late if we put all of our time and resources into one company without having meetings to work it into our schedule."
...
label v2_eta:
    ...
    menu:    
        "Be ambitious - I should be able to finish in 2 days!":
            ...
            goro "Between you and me, it's sometimes better to give yourself a few extra days more than you actually think it'll take to complete a project."
            ...
            goro "Like I said, it's awesome that you want to prove yourself here. But are you sure I get your word that you can handle your other assignments?"
...
label v2_css:
    lydia "Bye everyone! It's about that time of day - I'm about to pack up and head home."
    goro "Hold on there for a second, Lydia."
    goro "Can you do me a favor before you go?"
    lydia "Sure Goro! What's up?"
    ...
    lydia "Sure! I'll do that now before I leave."
    lydia "..."
    lydia "Okay, so it looks like there are some CSS classes that are clashing with each other on the homepage."
    lydia "I'm a bit worried, because one of the classes that are being used is used in a handful of other places."
    lydia "I could always use some inline CSS for a really quick fix, but I know that's generally kind of frowned-upon..."
    lydia "I could also stay a little later and work on a legitimate fix."

    menu:   
        "Quickly write out some inline CSS":
            lydia "It's pretty late... and I'm not sure when Mom or Dad will be home to feed Mint."
            lydia "I think I'm going to just add a little bit of inline CSS to fix this."
            ...
            if renpy.random.random() < 0.5:
                ...
                lydia "Ah! Goro. You spooked me. I thought you left for the day?"
                goro "Turns out I had a ticket of my own that I needed to hotfix. Did you finish up?"
                lydia "Um... yep! All done!"
                goro "Cool! What did you end up doing to come to a solution?"
                lydia "(Oh jeez, he's going to find out...)"
                goro "Hoooold on slugger - inline CSS?"
                goro "This is quick, but not always best practice."
                lydia "I figured it would be fine... it's getting pretty late."
                goro "Right, but I asked for you to take a look at your ticket."
                goro "It's okay to just get an idea of what's causing the problem and then returning to it in the morning."
                goro "I'd rather you have you properly spend time on a solution than throw in some inline CSS."
                goro "What if this problem re-appears in another page? Will we just keep copy-pasting the same few lines of CSS?"
                lydia "(Sigh)You're right."
                ...
                lydia "Right. I'll see you in the morning."
        ...
        "Spend some time fixing one of the conflicting classes":
            lydia "(Sigh) No point in kicking the can down the road..."
            lydia "There's a chance that it'll be someone else's problem one day - or maybe even mine."
            lydia "So I should probably do things right the first time."
            lydia "I'll give Mom or Dad a call to make sure that Mint is fed and get started on this."
...
label v2_thick:
    lydia "Ugh... it's 5PM and this is nowhere close to being done!"
    darius "Girl, you look STRESSED. What's going on?"
    lydia "It's this dumb ticket."
    lydia "Remember the Canyon Building Company's ticket? The one where we're building out a CRM for them?"
    ...
    lydia "Don't worry - I didn't know what the heck it was up until four days ago!"
    lydia "It stands for “Customer Relationship Manager”. "
    lydia "It's just a piece of software that allows you to keep track of things about a company's customers."
    lydia "You can do things like log all of their contact information, what point of the onboarding process they're in, records of past sales, and a lot more, depending on the software."
    lydia "That sort of thing."
    darius "Aaaah, gotcha. So what's going on with the CRM?"
    lydia "We all agreed during backlog grooming that fixing this bug would all take about four days to complete."
    lydia "But it's been FIVE days, and it looks like I'm barely halfway done. "
    lydia "I've asked Goro, Mike, and Mala for help dozens of times already."
    lydia "On one hand, I feel like something is just wrong with me and I'm being too slow with the ticket. "
    lydia "Like... Maybe I'm a bad developer."
    lydia "But maybe I'm not? Maybe something is wrong here?"
    ...
    lydia "Um... maybe Goro. Iris scares me."
    ...
    lydia "Thanks Darius. That means a lot."

    hide darius with moveoutright
    lydia "Hm... So what AM I going to do about this?"
    lydia "Maybe I SHOULD talk to Goro? Because this ticket is pretty hard. I don't know if it's normal for juniors to be able to do this much."
    lydia "On the other hand, I could definitely just stay a little later... I bet if I did that, I could have the ticket done by tomorrow evening."
    
    menu:
        "Talk to Goro about the ticket's difficulty.":
            lydia "No... I probably should talk to Goro about this."
            lydia "I've never, ever spent longer than three or four days on a ticket."
            lydia "They could be just trusting me with more responsibility, but maybe something else is going on?"
            goro "Hey, newbie. What's going on? You look tired."
            lydia "Thanks."
            goro "Hey, I didn't mean it that way! Is it about ticket 4522?"
            lydia "Yeah, the Canyon Building Company account."
            lydia "I've been working at this bug for the last five days... and I've been making progress, but it just feels like I've got a lot more to go."
            lydia "Do you mind taking a look at it?"
            goro "Sure! Let's see here."
            goro "... "
            goro "Hm."
            goro "I thought the function the last ticket added was just breaking one component?"
            lydia "Nope. Each time I make a change to it to fix one component, another one breaks."
            ...
            lydia "Jeez, I'm glad I said something!"
            lydia "What should I do now, then?"
            ...
            lydia "Thanks Goro! That's a huge relief..."
        ...
        "Push through until it's done.":
            lydia "(Sigh)"
            lydia "I think if I stay a bit late for a day or so, I may be able to finish this."
            lydia "I didn't sign up to become a developer to give up when things get hard."
            lydia "Besides, I don't want everyone to think that I'm a quitter."
            ...
            lydia "Hey Goro."
            lydia "I'm working on ticket 4522?"
            goro "The Canyon Building Company account, right?"
            goro "I was going to ask you about that. Have you been putting a dent in it?"
            lydia "About that... I wasn't going to say anything, because I should be done tomorrow, but I'm still at the office right now, working on it."
            goro "You're WHAT? Lydia, it's almost 8PM. It's not safe to be alone in the office that late."
            goro "Why didn't you ask for help??"
            lydia "To be honest, it just seemed like such a “junior” thing to do..."
            goro "But you ARE a junior."
            goro "What's the problem? Can you push up what you've done so far and start on your way home?"
            goro "I should have reviewed it by the time that you got back. "
            ...
            lydia "Okay. I'll start on my way back."

            scene bg bedroom night with fadehold
            goro "So I think I'm seeing what the problem is."
            goro "I thought the function the last ticket added was just breaking one component?"
            lydia "Nope. Each time I make a change to it to fix one component, another one breaks."
            lydia "So far, I've fixed about five of them, manually. "
            goro "How many more are there left to fix?"
            lydia "Around twelve."
            goro "Lydia! You've got to flag one of us when something like this happens."
...
label v2_success:
    mala "Hey Lydia? Can I talk to you for a sec?"
    lydia "Sure; What's up?"
    mala "I think I might have messed up. Like, REALLY messed up..."
    lydia "What's going on? I'm sure it can't be THAT bad."
    ...
    lydia "Well that's not too hard, right? That should be as simple as adding a Schmoogle Map to their website."
    ...
    lydia "Posted it?! You mean you saved it in a code repository?"
    lydia "A... PRIVATE repository, right?"
    mala "I wish it was!"
    lydia "Oh jeez... that IS a big deal. "
    lydia "You've taken it down already though, right?"
    mala "I have. I took it down as soon as possible. But I'm just kind of freaked out."
    mala "Schmoogle charges money for every 1,000 CRUD requests to their API, and we negotiated a free $100,000 in free credit for the Braze Salon."
    ...
    menu:
        "It was a mistake. It's okay to make mistakes.":
            lydia "Well... have you gotten any TeamChat messages about this?"
            mala "No, nothing so far."
            lydia "If that's the case, maybe you're being a little paranoid?"
            lydia "You accidentally posted the key, but then you took it down immediately. No harm done, right?"
            mala "I GUESS so..."
            lydia "Let's go grab some lunch. Maybe that'll take your mind off of things."
            "Later that afternoon..."
            lydia "Phew! I'm full! I think I can probably knock out this ticket before heading home for the day."
            lydia "Hm... What's this? Iris sent out an email?"
            lydia "It's flagged as 'URGENT'. Better read it so she doesn't have to talk to me about it in person."
            lydia "Or maybe she won't just talk to me - it looks like this has our whole department CC'd on it!"
            ...
            iris "But people with bad intentions of bots of their own. Some people create bots for the sole purpose of being able to steal API keys specifically."
            iris "The client could have lost a LOT of money because of this."
            iris "They were warned to take it off of the internet quickly, and warned them of what the consequences would be if it were to be found."
            iris "As you can imagine... this was not a good look for our company."
            iris "Had we been notified of this issue, we could address this possibly before our client even saw the email."
            iris "We would have the appearance of a company that makes mistakes, but ultimately keeps them under control."
            iris "Now, our senior developers are in a meeting to do their best not to lose this client. Our client feels blind-sided. Betrayed."
            iris "Do not be like... our 'anonymous employee'. Do not withhold information that could hinder yourself or your team."
        ...
        "Should we tell someone about this?":
            lydia "I don't know if NOT telling someone is a good idea."
            lydia "There's nothing that you can do about having posted the key, but my gut tells me that you should tell someone on the team."
            mala "(Sigh)... You're right, you're right."
            mala "I just... don't want to have to tell IRIS of all people..."
            lydia "Yeah. You couldn't pay me enough to want to do that."
            lydia "But that's the good thing of telling someone on your own terms, right?"
            lydia "You can tell Goro, and GORO can tell Iris. They seem to have a pretty good relationship."
            lydia "Somehow."
            ...
            lydia "Definitely - I've been wanting to try that Thai place down the street from the office for a week!"
            "20 minutes pass before Mala returns."
            lydia "You look like you're in a good mood! Everything okay?"
            ...
            lydia "Jeez!"
            lydia "What would have happened if we didn't say anything?"
            mala "Well, Goro told me that he's done something similar once with another service."
            mala "He said that the service immediately sent out an email to him, warning him that one of their bots detected an key publicly published."
            lydia "A 'bot'?"
            ...
            lydia "Awesome! That's good, right?!"
            mala "..."
            lydia "Ok!"
            lydia "Or not!"
            lydia "Tell me why that's not good?"
            mala "People with bad intentions of bots of their own. Some people create bots for the sole purpose of being able to steal API keys specifically."
            ...
            lydia "I see. And that would have looked pretty bad on us..."
            ...
            lydia "Really?! Wow! I thought that would be a part of the process?"
            ...
            lydia "..."
            lydia "Let's not think about that now."
            mala "Yeah."
            mala "So. Thai food?"
            lydia "Thai food!"
...
label v2_competent:
    goro "Lydia! How's ticket #999 going?"
    lydia "I'd say it's going well, but I haven't gotten started on it yet!"
    goro "No problem - do you remember what this one is for?"
    lydia "To be honest with you, my brain was a little fried this morning during our meeting. I was going to read through the ticket again."
    goro "Want me to spare you a bit of time?"
    lydia "I won't say no to that!"
    goro "Cool! Basically, Juan's going to be out for a few months."
    lydia "What? The mid-level developer, right? Is everything okay?"
    ...
    lydia "So that's why I haven't seen him around - good for them!"
    goro "We tried to get as much information out of him for the things that he's written that we could before he left. Things were going fine for a few days,"
    ...
    lydia "Woah... I agreed to doing that?"
    ...
    lydia "To be honest, I haven't, but I'll do my best!"
    goro "Awesome! You know to come grab me if you need a bit of help."
    lydia "Okay... so."
    lydia "I'll need to figure out how this function works, so I can fix it."
    lydia "The ticket says that the function is called background_jobs(), and what document it's in."
    lydia "Where should I start?"
    ...
    menu v2_competent_choices:
        ...
        "Use Universal Search to find other places that the function is used":
            lydia "A good place to start would probably be to run a Universal Search!"
            lydia "Using this, I can search every single document in our repo. Which also let's me see all of the places that background_jobs() is being ran."
            lydia "Okay... so this is used in a TON of places. (sweatdrop)"
            lydia "But, I think with a bit of looking, I can find examples of people using the function."
            lydia "That way, I can get an idea of what situations it's meant to be used in. This will give me a clue on hwo the function is supposed to be used."
            jump v2_competent_choices

        "Look at tests for the function":
            lydia "Hm... I should probably check all of the tests for this function."
            lydia "Usually, tests have descriptive blocks of code that explain exactly what a test is meant to be checking for."
            lydia "The texts can give me a hint on what the function is meant to do."
            lydia "Plus, I can run all of the tests for the function and pay close attention to the tests that are failing."
            lydia "This can tell me where I'm meant to start to get them fixed! And I can be more certain things are working right when all of the tests pass."
            jump v2_competent_choices

        "Call the function in the console and play around with it a bit":
            lydia "If I want to see how a function is meant to work, I can always play with it in the console!"
            lydia "Most languages have a console of some sort where I can write code and it will execute immediately."
            lydia "Since this project's backend is Ruby on Rails, I'll mess around and use the function in the Rails console in a few different ways."
            lydia "I can test a few different arguments and situations with this function, and maybe it'll help me find out where it's breaking."
            lydia "Then once I re-write the function, I can manually test it here in the console as well!"
            jump v2_competent_choices

        "Ask the developer who created the function":
            lydia "Normally this would be a good option..."
            lydia "If the developer who created the function was actually here! Juan is on paternity leave, remember? (sigh)"
            jump v2_competent_choices

        "I think I have all of the information I need" if len(v2_competent_choices_visited) > 2:
            lydia "Alright! I think that's enough information gathered for now."
            lydia "Time to get started on chasing this bug!"

    "You work for the next hour or so on the bug. You were able to use all of your usual methods to diagnose the issue with a function, and all of the duplicates are being deleted!"
    ...
    lydia "...and that's how I got to where I am now."
    lydia "So what do you think? Does this all look right to you?"
    ...
    lydia "Thanks!"
    lydia "By the way, did we ever figure out what was going on with what's creating the duplicates in the first place? (question mark)"
    goro "We sure did!"
    ...
    lydia "It's always the little things!"
...
label v2_automate:
    ...
    lydia "Not exactly... can you explain one more time?"
    ...
    lydia "But... WHY? There is a LOT of minutes here - it feels like it's going to take forever."
    goro "Yeah. (sideways face)"
    goro "It usually takes me a good 45 minutes to complete this... and that's when I'm feeling focused. It usually takes me a little over an hour."
    goro "To answer your question, there isn't really a "why" to it, either. It's an inefficient system, unfortunately."
    goro "Plenty of other teams don't do this, but it's something that management wants to make sure that we're spending our time well."
    ...
    lydia "Jeez... I guess it's time to get started."
    lydia "I know that Goro says this is the way that things have always been done, but there's got to be a faster way."
    lydia "Hm... maybe I can just automate the process with something like Python?"
    lydia "I remember scrolling through Youtube and seeing a video from FreeCodeCamp about automating Excel sprpeadsheets using Python."
    lydia "Maybe I could do the same thing?"
    lydia "But... Goro just spent all that time explaining how to do our minutes. I'm sure there's a REASON no one has automated things up until this point."
    lydia "And I've never automated anything before. What should I do?"

    menu:
        "Do things the long way, automate some other time.":
            lydia "Hm... Maybe I should automate this some other time."
            lydia "Goro just spent all of this time showing me how to do things the way they've always been done. Maybe he did that for a reason?"
            lydia "And maybe there's a reason no one has automated this yet in the first place?"
            lydia "Maybe it'll even be ideal for me to do this the long way once or twice and take some notes so I can best know how to automate this in the future."
            lydia "Oh well... I'd better get started."
            "On one hand, you're happy you played things safe."
            "But what Goro taught you barely scratched the surface of how long doing minutes manually would actually take you."
        ...
        "Spend some time automating the minutes process.":
            lydia "Hm... I really can't help but shake the idea that this process can be automated."
            lydia "First, I could start by making a copy of the original and second spreadsheet in case I mess things up."
            lydia "Then, I could start by doing just one or two rows of data."
            lydia "I could make a list of all of the tasks that have to be performed to get those done... like transferring a list item from the text document to row one, column one of the second spreadsheet."
            lydia "Once there's a linebreak "
            lydia "I could make a list of those actions, program them out, turn that list into code, and do that until the process is done..."
            ...
            "But as you run your script, you realize you're missing a few test cases. Like how minutes entries for Fridays have one or two more meetings in them than Wednesdays."
            ...
            lydia "Hold on. oooone sec..."
            lydia "Aaaaaand... done! Take a look at this! (SMILE)"
            goro "..."
            goro "No way! (Shocked)"
            goro "Did you automate transferring our minutes over to the spreadsheet?"
            lydia "I sure did!"
            lydia "It's not 100% perfect - there's one or two fields in the spreadsheet that we need to fill out manually, but this covers about 80% of the work."
            goro "About how long does it take you now?"
            lydia "I'd have to say about... 10 minutes, since the script takes about 10 seconds to run, and the rest of the time covers the manual parts."
...
label v2_email:
    ...
    menu mysterious_email_choices:    
        ...
        "Something's not right here..." if found_problem:
            ...
            player "Oh! So ConsultMe must performs these to make sure that we're staying on our toes about our company's private information! I'm glad I listened to my gut!"
...
label v2_venting:
    ...
    menu:
        "Vent to Mom":
            ...
            player "I can. It's just the things would just go much faster if they used an API, and -"
            ...
            "It turns out that sharing stories at work requires a certain level of knowledge of what you do to talk about it."
        ...
        "Vent to Annika":
            ...
            player "I love Mom, but I have a feeling that she wouldn'tve understood what I was talking about if I got into even a little bit of detail."
        ...
        "Vent Online":
            ...
            "Users definitely are understanding; Some even offer tips on how to work with employees like that in the future."
...
label v2_running_late:
    ...
    menu:
        ...
        "Message someone in your TeamChat and tell the team you're running late.":
            ...
            player "Or, now that I think about it - I hadn't even thought of how much it'll take to get to our department!"
...
label v2_crypto:
    ...
    player "Looking them up, of these seem so cool. Maybe those two are right, and these technologies are the future..."
    ...
    menu:
        "Learn about Blockchain technology and Fresssh.":
            ...
            goro "We could certainly use it, but there are far, far less Blockchain developers than, say, Ruby on Rails developers."
            ...
            goro "Just understand that in the future, as you develop your skills as a junior, that you stick with popular technologies."
...
label v2_old_friend:
    ...
    menu:
        "Would you like me to refer you to a position at my company?":
            player "I've been thinking ConsultMe has another junior position open right now. Would you like me to refer you to it?"
...
label v2_equity:
    ...
    menu:
        "Accessibility is important.":
            ...
            player "Computers and phones usually have screen-readers on them, which is special software that reads content on a screen aloud."
...
label v2_internet_safety:
    ...
    menu:
        "Connect to the Hackerspace wifi and commit.":
            ...
            layla "Just having been on a public network doesn't mean you definitely got information stolen. But it definitely does open yourself up to the risk."
