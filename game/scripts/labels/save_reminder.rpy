label save_reminder:
    ...
    call screen confirm("Would you like to save your progress up to now?", 
        ...
        no_action=Return())
    if persistent.enable_save_reminder is None: # first time player needs to set this up
        ...
        "(Hey, just wondering... Do you find my reminders useful? If not, feel free to turn them off. I won't be offended.)"
    call screen confirm("Would you like to receive reminders to save every now and then? You can turn them off at any time in {icon=icon-settings} Settings > Others.", 
