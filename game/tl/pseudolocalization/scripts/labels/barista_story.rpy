...
translate pseudolocalization barista_fullstack_6903e887:

    # female "So I heard that you've moved up to a new role? Congrats!"
    female ""

# game/scripts/labels/barista_story.rpy:7
translate pseudolocalization barista_fullstack_a6e3fb86:

    # female "What do you do now?"
    female ""

# game/scripts/labels/barista_story.rpy:8
translate pseudolocalization barista_fullstack_dc27892f:
...
translate pseudolocalization barista_fullstack_a00f75a1:

    # player @ surprised "{b}Full-stack{/b}... What is that? I better take notes so I can learn more about it."
    player @ surprised ""

# game/scripts/labels/barista_story.rpy:12
translate pseudolocalization barista_fullstack_72ffd990:

    # player @ smile "Added it to my To-Do list!"
    player @ smile ""

# game/scripts/labels/barista_story.rpy:18
translate pseudolocalization barista_devops_494ce9e6:
...
translate pseudolocalization barista_devops_677cf284:
...
translate pseudolocalization barista_devops_72ffd990:

    # player @ smile "Added it to my To-Do list!"
    player @ smile ""

# game/scripts/labels/barista_story.rpy:31
translate pseudolocalization barista_machinelearning_2568a203:

    # college_girl "Hey hey hey look at this cool thing we did for our course project!"
    college_girl ""

# game/scripts/labels/barista_story.rpy:32
translate pseudolocalization barista_machinelearning_f89a5199:
...
translate pseudolocalization barista_conference_176a8c36:
...
translate pseudolocalization barista_conference_f30e9b4d:

    # girl "Oh... That doesn't sound too bad. What exactly can I expect?"
    girl ""

# game/scripts/labels/barista_story.rpy:52
translate pseudolocalization barista_conference_fb061238:
...
translate pseudolocalization barista_agile_e187335b:
...
translate pseudolocalization barista_api_d88e1506:

    # college_boy "That sounds like a good idea!"
    college_boy ""

# game/scripts/labels/barista_story.rpy:77
translate pseudolocalization barista_api_ed4fc9d5:
...
translate pseudolocalization barista_api_92987c79:
...
translate pseudolocalization barista_api_43b939fb:

    # college_girl "... Okay. Whatever you say. Let's get to work."
    college_girl ""

# game/scripts/labels/barista_story.rpy:80
translate pseudolocalization barista_api_f263031c:
...
translate pseudolocalization barista_userexperience_00c14311:

    # college_boy "Sure! So it all started with this program at my school..."
    college_boy ""

# game/scripts/labels/barista_story.rpy:94
translate pseudolocalization barista_userexperience_10f92fa5:
...
translate pseudolocalization barista_versioncontrol_e10a10a9:

    # girl "... I'm not thanking you for breaking the code, you know."
    girl ""

# game/scripts/labels/barista_story.rpy:111
translate pseudolocalization barista_versioncontrol_474172a9:
...
translate pseudolocalization barista_versioncontrol_72ffd990:
